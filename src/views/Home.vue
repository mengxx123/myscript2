<template>
    <div>
        <div class="result-box">
            <div class="tab-header">
                <ui-tabs :value="activeTab" @change="handleTabChange">
                    <ui-tab value="tab1" title="Math"/>
                    <ui-tab value="tab2" title="LaTeX"/>
                    <ui-tab value="tab3" title="MathML"/>
                </ui-tabs>
            </div>
        ...
        <nav>
            ...
            <button id="clear" class="nav-btn btn-fab-mini btn-lightBlue" :disabled="clearDisable" @click="clear">
                <img src="/static/img/clear.svg">
            </button>
            <button id="undo" class="nav-btn btn-fab-mini btn-lightBlue" :disabled="undoDisable" @click="undo">
                <img src="/static/img/undo.svg">
            </button>
            <button id="redo" class="nav-btn btn-fab-mini btn-lightBlue" :disabled="redoDisable" @click="redo">
    ...
    export default {
        ...
        mounted() {
            ...
            editorElement.addEventListener('changed',  event => {
                this.undoDisable = !event.detail.canUndo;
                this.redoDisable = !event.detail.canRedo;
                this.clearDisable = event.detail.isEmpty;
            })
            ...
            editorElement.addEventListener('exported', evt => {
                console.log('exported', evt.detail)
                const exports = evt.detail.exports;

                this.mathml = exports['application/mathml+xml']
            ...
            MyScript.register(editorElement, {
                ...
                v4: {
                    math: {
                    mimeTypes: ['application/mathml+xml', 'application/x-latex', 'application/vnd.myscript.jiix']
                    },
                    export: {
                    jiix: {
                        strokes: true
